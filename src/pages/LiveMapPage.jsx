    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="text-center space-y-4 py-4 relative">
                ...
                <p className="text-gray-500 font-bold uppercase tracking-[0.4em] text-xs">See where your vehicles are right now</p>
            ...
            <div className="flex flex-col lg:flex-row gap-8 h-[750px]">
                ...
                <div className="w-full lg:w-96 bg-white border border-gray-100 rounded-[2.5rem] flex flex-col shadow-sm overflow-hidden">
                ...
                <div className="flex-1 rounded-[3rem] border border-gray-100 overflow-hidden relative shadow-2xl bg-gray-100">
                    ...
                    {selectedVehicle && (
                        <motion.div
                            ...
                            className="absolute bottom-10 left-10 right-10 bg-white/90 backdrop-blur-xl border border-white/20 p-8 rounded-[2.5rem] shadow-2xl z-20 flex justify-between items-center"
                        >
                            <div className="flex gap-12">
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Current Driver</p>
                                    <p className="text-xl font-black text-gray-900">{selectedVehicle.driverName || 'N/A'}</p>
                                </div>
                                <div className="h-12 w-[1px] bg-gray-200/50"></div>
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Fuel Status</p>
                                    <p className="text-xl font-black text-gray-900">{selectedVehicle.fuelLevel}%</p>
                                </div>
                                <div className="h-12 w-[1px] bg-gray-200/50 flex"></div>
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">GPS ID</p>
                                    <p className="text-xl font-black text-[#21a0b5]">{selectedVehicle.deviceId || 'N/A'}</p>
                                </div>
                            </div>

                            <div className="flex gap-4">
                                <button className="bg-gray-100 text-gray-600 px-6 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-gray-200 transition-all">Route History</button>
                                <button className="bg-[#21a0b5] text-white px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-[#21a0b5]/20 hover:scale-105 transition-all">Live Video</button>
                            </div>
                        </motion.div>
                    )}
